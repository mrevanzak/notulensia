...
function PanelDemo(): ReactElement {
  ...
  const toolbarLeftTemplate = (): ReactElement => {
    return (
      <>
        <Button icon="pi pi-plus" label="New" style={{marginRight: ".5em"}} />
        <Button icon="pi pi-folder-open" label="Open" severity="secondary" />
        ...
        <div className="card">
          ...
          <div className="grid">
            ...
            <div className="col-5 align-items-center justify-content-center">
              ...
              <Divider align="right">
                <Button icon="pi pi-search" label="Button" outlined />
              </Divider>
