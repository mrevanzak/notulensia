        ...
        return (
          ...
          >
                  ...
                  >
                    <div className="flex flex-column lg:flex-row justify-content-center align-items-center px-2">
                      ...
                      <div className="flex flex-column my-auto text-center md:text-left">
                        ...
                        <a className="p-ripple p-2 select-none cursor-pointer w-10rem mx-auto lg:mx-0 border-round font-medium text-center border-1 border-primary text-primary transition-duration-150">
                          Buy Again{" "}
            ...
            <div className="col-12 p-0 flex border-top-1 surface-border">
              ...
              >
                <i className="pi pi-folder mr-2 mb-2 md:mb-1" />
                Archive Order
              </a>
              <a className="cursor-pointer py-4 flex flex-column md:flex-row text-center justify-content-center align-items-center text-primary hover:bg-primary hover:text-0 transition-duration-150 w-full">
                <i className="pi pi-refresh mr-2 mb-2 md:mb-1" />
                Return
              </a>
              <a className="cursor-pointer py-4 flex flex-column md:flex-row text-center justify-content-center align-items-center text-primary hover:bg-primary hover:text-0 transition-duration-150 w-full">
                <i className="pi pi-file mr-2 mb-2 md:mb-1" />
                View Invoice
              </a>
              <a
                className="cursor-pointer py-4 flex flex-column md:flex-row text-center justify-content-center align-items-center text-primary hover:bg-primary hover:text-0 transition-duration-150 w-full"
              ...
              >
                <i className="pi pi-comment mr-2 mb-2 md:mb-1" />
                Write a Review
              </a>
            </div>
          </div>
