          ...
          <div className="col-12 md:col-6 p-6 text-center md:text-left flex align-items-center ">
            <section>
              ...
              <Button
                ...
                type="button"
              />
              <Button label="Live Demo" outlined type="button" />
            </section>
          </div>
          <div className="col-12 md:col-6 overflow-hidden">
            <img
            ...
            <div className="col-12 lg:col-4">
              <div className="p-3 h-full">
                ...
                >
                  ...
                  <hr className="mb-3 mx-0 border-top-1 border-none surface-border mt-auto" />
                  <Button className="p-3 w-full mt-auto" label="Buy Now" />
                </div>
              </div>
            </div>
            ...
            <div className="col-12 lg:col-4">
              <div className="p-3 h-full">
                ...
                >
                  ...
                  <hr className="mb-3 mx-0 border-top-1 border-none surface-border" />
                  <Button className="p-3 w-full" label="Buy Now" />
                </div>
              </div>
            </div>
            ...
            <div className="col-12 lg:col-4">
              <div className="p-3 h-full">
                ...
                >
                  ...
                  <hr className="mb-3 mx-0 border-top-1 border-none surface-border" />
                  <Button className="p-3 w-full" label="Buy Now" outlined />
                </div>
              </div>
            </div>
          </div>
            ...
            <div>
              ...
              <div className="flex align-items-center justify-content-between mb-6">
                <div className="flex align-items-center">
                  ...
                  />
                  <label className="text-900" htmlFor="rememberme">
                    Remember me
                  </label>
                </div>
        ...
        <div className="surface-0">
          ...
          <ul className="list-none p-0 m-0">
            ...
            <li className="flex align-items-center py-3 px-2 border-top-1 border-300 flex-wrap">
              <div className="text-500 w-6 md:w-2 font-medium">Genre</div>
              <div className="text-900 w-full md:w-8 md:flex-order-0 flex-order-1">
                <Chip className="mr-2" label="Crime" />
                <Chip className="mr-2" label="Drama" />
                <Chip label="Thriller" />
              </div>
              <div className="w-6 md:w-2 flex justify-content-end">
                <Button icon="pi pi-pencil" label="Edit" text />
