  ...
  return (
    <div className="card">
        ...
        <div>
          ...
          <div className="flex flex-wrap justify-content-center md:justify-content-start gap-3">
            <span className="inline-flex align-items-center py-2 px-3 font-medium border-1 surface-border border-round">
              <i className="pi pi-clock text-primary mr-2" />
              <span className="text-900">2d ago</span>
            </span>
            <span className="inline-flex align-items-center py-2 px-3 font-medium border-1 surface-border border-round">
              <i className="pi pi-comments text-primary mr-2" />
              <span className="text-900">24</span>
            </span>
            <span className="inline-flex align-items-center py-2 px-3 font-medium border-1 surface-border border-round">
              <i className="pi pi-eye text-primary mr-2" />
      ...
      <div className="flex flex-column sm:flex-row my-8 w-full gap-3">
        <Button icon="pi pi-twitter" label="Twitter" severity="secondary" />
        <Button icon="pi pi-facebook" label="Facebook" severity="secondary" />
        <Button
          className="sm:ml-auto"
          icon="pi pi-pencil"
          label="Edit Post"
          onClick={() => {
            router.push("/apps/blog/edit");
          }}
        />
      </div>
      ...
      <div className="mb-3 p-fluid">
        <InputTextarea placeholder="Your comment" rows={6} />
      </div>
