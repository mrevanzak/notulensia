...
function ProductOverview(): ReactElement {
          ...
          <div className="flex align-items-center justify-content-between mb-5">
            ...
            <div className="flex align-items-center">
              <span className="mr-3">
                ...
                <i className="pi pi-star-fill text-yellow-500 mr-1" />
                <i className="pi pi-star-fill text-yellow-500 mr-1" />
                <i className="pi pi-star text-600 mr-1" />
              </span>
          ...
          <ul className="list-none p-0 m-0">
            <li className="pb-5 border-bottom-1 surface-border">
              <span>
                ...
                <i className="pi pi-star-fill text-yellow-500 mr-1" />
                <i className="pi pi-star-fill text-yellow-500 mr-1" />
                <i className="pi pi-star-fill text-gray-500" />
              </span>
