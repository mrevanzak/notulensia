...
function MenuDemo({children}: any): ReactElement {
  ...
  const wizardItems = [
    {
      label: "Personal",
      command: () => {
        router.push("/uikit/menu");
      },
    },
    {
      label: "Seat",
      command: () => {
        router.push("/uikit/menu/seat");
      },
    },
    {
      label: "Payment",
      command: () => {
        router.push("/uikit/menu/payment");
      },
    },
    {
      label: "Confirmation",
      command: () => {
        router.push("/uikit/menu/confirmation");
      },
    },
  ];
  ...
  const menubarEndTemplate = (): ReactElement => {
    return (
  ...
  return (
    <div className="grid p-fluid">
      <div className="col-12">
        <div className="card">
          <h5>Menubar</h5>
          <Menubar end={menubarEndTemplate} model={nestedMenuitems} />
        </div>
      </div>
      ...
      <div className="col-12 md:col-4">
        <div className="card">
          ...
          <Menu model={overlayMenuItems} popup ref={menu} />
          <Button
      ...
      <div className="col-12 md:col-6">
        <div className="card">
          ...
          <MegaMenu breakpoint="767px" model={megamenuItems} />
