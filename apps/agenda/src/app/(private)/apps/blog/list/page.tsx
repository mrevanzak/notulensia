...
function BlogList(): ReactElement {
  ...
  const onSortChange = (event: DropdownChangeEvent): void => {
    ...
    setSortKey(event.value as string);
  };

  const itemTemplate = (blog: Blog): ReactElement => {
    return (
        ...
        <div className="surface-section px-4 py-8 md:px-6 lg:px-8">
          ...
          <div className="grid nogutter">
            <div className="col-12 lg:col-4 p-4">
              <div className="border-top-3 border-blue-600" />
            ...
            <div className="col-12 lg:col-4 p-4">
              <div className="border-top-3 border-pink-600" />
            ...
            <div className="col-12 lg:col-4 p-4">
              <div className="border-top-3 border-orange-600" />
