...
function AccessDenied2(): ReactElement {
      ...
      <div className="flex align-items-center justify-content-center relative">
        ...
        <div className="h-screen flex justify-content-center align-items-center w-full lg:w-6">
          <div className="z-5 w-6 h-6">
            <span className="text-lg bg-yellow-500 p-1 px-2 border-round-md text-0">
              401
            </span>
            <h1 className="text-6xl font-light my-4 mx-0 text-yellow-500">
              Access Denied
            </h1>
            <div
              className="w-7rem bg-yellow-500"
              style={{height: "1px", backgroundColor: "#9199a9"}}
            />
            <p className="mt-4 text-lg text-color">
              You do not have the necesary permisions. Please contact admins.
            </p>
            <Button
              className="mt-5 border-none bg-yellow-500"
        ...
        >
          <defs>
            <linearGradient id="c" x1="50%" x2="50%" y1="0%" y2="100%">
              <stop offset="0%" stopColor="var(--yellow-200)" />
              <stop offset="99.052%" stopColor="var(--yellow-300)" />
            </linearGradient>
            <path
            ...
            <linearGradient id="d" x1="50%" x2="50%" y1="0%" y2="99.142%">
              <stop offset="0%" stopColor="var(--yellow-300)" />
